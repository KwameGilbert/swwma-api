...
class DatabaseSeeder extends AbstractSeed
{
    ...
    private function seedUsers(): void
    {
        ...
        $users = [
            ...
            ['name' => 'Agent User Extra', 'email' => 'agent@gmail.com', 'phone' => '+233202222222', 'password' => $this->hashPassword('Password@123'), 'role' => 'agent', 'email_verified' => true, 'email_verified_at' => date('Y-m-d H:i:s'), 'status' => 'active', 'first_login' => false],
            ['name' => 'Officer User Extra', 'email' => 'officer@gmail.com', 'phone' => '+233203333333', 'password' => $this->hashPassword('Password@123'), 'role' => 'officer', 'email_verified' => true, 'email_verified_at' => date('Y-m-d H:i:s'), 'status' => 'active', 'first_login' => false],
            ['name' => 'Taskforce User Extra', 'email' => 'taskforce@gmail.com', 'phone' => '+233204444444', 'password' => $this->hashPassword('Password@123'), 'role' => 'task_force', 'email_verified' => true, 'email_verified_at' => date('Y-m-d H:i:s'), 'status' => 'active', 'first_login' => false],
        ];
    ...
    private function seedContactInfo(): void
    {
        ...
        $contacts = [
            ...
            ['type' => 'email', 'label' => 'General Enquiries', 'value' => 'info@gmail.com', 'icon' => 'mail', 'link' => 'mailto:info@gmail.com', 'display_order' => 4, 'status' => 'active', 'created_by' => 1],
            ['type' => 'email', 'label' => 'Support', 'value' => 'support@gmail.com', 'icon' => 'help-circle', 'link' => 'mailto:support@gmail.com', 'display_order' => 5, 'status' => 'active', 'created_by' => 1],
